...
function firstQuestion(){
    ...
    Swal.fire({
        title: 'He luu bạn!',
        text: 'Mình có điều này muốn hỏi bạn nhớ phải trả lời thật lòng nhaaa.',
...
function textGenerate() {
    var n = "";
    var text = " Tại vì bạn trang xinh gái  vch :<<<<<<< ";
...
$('#yes').click(function() {
    ...
    audio.play();
    Swal.fire({
        title: 'Nói cho tớ lí do bạn thích mình đi :vvvv',
        html: true,
        width: 900,
        padding: '3em',
        ...
        if (result.value) {
            Swal.fire({
                ...
                background: '#fff url("img/iput-bg.jpg")',
                title: 'Mình biết mà ^^ Yêu bạn 3000',
